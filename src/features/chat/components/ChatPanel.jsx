...
import VoiceInput from '../../transcription/components/VoiceInput';
                  ...
                  {message.type === 'bot' && (
                    <button
                      ...
                      className={`
                        ...
                        ${copiedId === message.id ? 'text-green-500' : 'text-gray-400 hover:text-gray-600'}
                      `}
                      title={copiedId === message.id ? 'คัดลอกแล้ว' : 'คัดลอก'}
                    >
                      <SafeIcon icon={copiedId === message.id ? FiCheck : FiCopy} className="w-4 h-4" />
                    </button>
                  )}
                </div>
              </div>
        ...
        <div className="flex gap-2">
          <div className="flex-1 relative">
            <textarea
              ...
              className="w-full p-3 pr-12 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#954eda] focus:border-transparent resize-none"
              rows={1}
